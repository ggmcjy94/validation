...
//        ValidationUtils.rejectIfEmptyOrWhitespace(bindingResult, "itemName", "required"); 밑에꺼랑 같음
        //검증 로직
        if (!StringUtils.hasText(item.getItemName())) {
...
//    @PostMapping("/add")
    ...
    @PostMapping("/add")  // @Validated Init 설정
